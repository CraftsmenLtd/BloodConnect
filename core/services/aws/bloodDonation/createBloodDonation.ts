...
async function createBloodDonationLambda(event: APIGatewayProxyEvent): Promise<APIGatewayProxyResult> {
  ...
  await bloodDonationService.createBloodDonaiton(bloodDonationAttributes, new DynamoDbTableOperations<DonationDTO, DonationFields, BloodDonationModel>(new BloodDonationModel()))
