...
while IFS= read -r shard; do
    ...
    iterator=$(aws dynamodbstreams get-shard-iterator --stream-arn "arn:aws:dynamodb:ap-south-1:211125655549:table/i-83-create-blood-request-bloodConnect-table/stream/2024-10-20T20:14:29.573" --shard-id "$shard" --shard-iterator-type TRIM_HORIZON --region ap-south-1 --query 'ShardIterator' --output text)
