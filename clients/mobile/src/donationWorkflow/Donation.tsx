      ...
      <View style={styles.container}>
        <ScrollView showsVerticalScrollIndicator={false}>
          ...
          <DateTimePickerComponent
            label="Time and Date"
            value={bloodRequestData.donationDateTime}
            onChange={(date) => handleInputChange('donationDateTime', date)}
          ...
          <Button text='Post Now' onPress={handlePostNow} disabled={isButtonDisabled} loading={loading} />
        </ScrollView>
      </View>
